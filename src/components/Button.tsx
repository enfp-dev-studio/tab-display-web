...
export const AppleButton = (props: Props) => {
  return (
    <div className="auto-center flex h-12 flex-row items-center space-x-3 rounded bg-primary px-6 py-2.5 shadow-md transition  duration-150 ease-in-out hover:cursor-pointer hover:opacity-90 hover:shadow-lg focus:shadow-lg focus:outline-none active:shadow-lg">
      <svg
        role="img"
        width={"100%"}
        height={"100%"}
      ...
      <button
        ...
        onClick={props.onClick}
        type="button"
        className="leading-12 inline-block text-xl font-light leading-tight text-white"
      >
        {props.children}
      </button>
    </div>
